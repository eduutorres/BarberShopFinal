 ...
 * @author Luiz Torres
 */
public class TelaCadServicos extends javax.swing.JDialog {

    /**
     * Creates new form TelaServicos
     */
    public TelaCadServicos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaCadServicos dialog = new TelaCadServicos(new javax.swing.JFrame(), true);
