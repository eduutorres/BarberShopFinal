 ...
 * @author Luiz Torres
 */
public class TelaAgendamentos extends javax.swing.JDialog {

    /**
     * Creates new form TelaAgendamentos
     */
    public TelaAgendamentos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaAgendamentos dialog = new TelaAgendamentos(new javax.swing.JFrame(), true);
